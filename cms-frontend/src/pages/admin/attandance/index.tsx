...
import { StaffListCard } from '../../../components/attendance/StaffListCard';
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-8">
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold text-gray-900">Admin Absensi</h1>
                            <p className="text-gray-600 mt-1 text-sm lg:text-base">Kelola kehadiran dan pantau staff</p>
                        </div>
                    </div>
                    <div className="flex items-center space-x-2 flex-wrap gap-2">
                        <Button
                            ...
                            disabled={isLoading}
                            className="bg-white border-gray-300 text-gray-700 hover:bg-gray-50 px-3 py-2 text-sm rounded-xl font-medium shadow-sm transition-all duration-200"
                        >
                            📅 Bulan Ini
                        </Button>
                        <Button
                ...
                {/* Main Content Grid - Layout yang Lebih Responsive */}
                <div className="grid grid-cols-1 xl:grid-cols-4 lg:grid-cols-3 gap-6">
                    {/* Left Column - Time & Attendance Action & Stats */}
                    ...
                    <div className="xl:col-span-4 lg:col-span-3 xl:block">
                        <StaffListCard
                            todayAttendances={todayAttendances}
                            isLoading={isStaffLoading}
                            onRefresh={loadTodayAttendances}
                        />
                    </div>
                </div>
            </div>
